...
import { ShieldCheckIcon, LockClosedIcon, KeyIcon } from '@heroicons/vue/24/outline';
        ...
        <div class="max-w-md w-full">
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-white overflow-hidden p-10 space-y-8">
                ...
                <div class="text-center space-y-2">
                    ...
                    <h1 class="text-2xl font-bold text-slate-900 tracking-tight">New Password</h1>
                    <p class="text-sm text-slate-500">Please choose a complex password to secure your account access.</p>
                </div>

                <form @submit.prevent="submit" class="space-y-6">
                    <!-- Email (Hidden for UI cleanliness but required) -->
                    ...
                    <div class="space-y-1.5 text-left">
                        ...
                        <p v-if="form.errors.password_confirmation" class="text-[10px] font-bold text-red-500 ml-1">{{ form.errors.password_confirmation }}</p>
                    </div>
